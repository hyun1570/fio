...
/**
 * <pre>
 *  수정 공통 수정 공통 (DDTA.BASE.SERVICE.U00)
 *
 *  개발자              : 박상민
 *
 *  작성날짜            : 20140409
 ...
 * </pre>
 */
public class UpdateService extends NormalTxService
{
    /**
     * FuncName : UpdateService()
     * FuncDesc : 생성자
     * Param    :
     * Return   :
     * Author   : 박상민
     * History  : 2014-04-10
    */
    public UpdateService(Class clazz) throws FrameException
    {
        super(clazz);
    }
