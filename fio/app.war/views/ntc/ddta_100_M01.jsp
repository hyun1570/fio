...
$(window).load(function()
{
    ...
    boardId = "<%= request.getParameter("boardId") %>"; // 전달받은 param 값
    ...
    $.ajax({
        ...
        success    : function(result)
        {
            ...
            $("#contents").cleditor();
            $("#contents").cleditor()[0].focus();
            
            setWriteLock(); // Write Lock 설정
...
function setWriteLock()
{
    ...
    if ('${SESSION_USER_ID}' != frm.regId.value)
    {
        ...
        document.getElementById("delBtn").style.display = "none"; // 저장 버튼 Hidden
        document.getElementById("fileUpBtn").style.display = "none"; // 저장 버튼 Hidden
        document.getElementById("fileDelBtn").style.display = "none"; // 저장 버튼 Hidden
    }
}
...
function getPageAction(action)
{
    switch (action)
    {
        ...
        case 3 : // 수정
            ...
            if (confirm("'공지사항'을 '수정' 하시겠습니까?") == false) return;
            ...
            jsonObj.sqlid           = "Notice.UPT_NOTICE";
        ...
        case 4 : // 삭제
            ...
            if (confirm("'공지사항'을 '삭제' 하시겠습니까?") == false) return;
                ...
                jsonObj.boardId = frm.boardId.value;
                ...
                $.ajax({
                    ...
                    success    : function(result)
                    {
                        if (result == "SUCCESS")
                        {
                        	delNoticeFile(frm.boardId.value);    // 파일 삭제
            ...
            <form id="frm" name="frm">
                            ...
                            <table class="attachfile" >
                              <tr>
                                <td class="attachfile_btn_area">
                                    <a href="javascript:void(0)" class="btn_intd_attach mb4" onclick="getAttachAction(3)" id="fileUpBtn"><span class="btn_intd_attach_left">파일업로드</span></a>
                                    <a href="javascript:void(0)" class="btn_intd_deletefile mb4" onclick="getAttachAction(4)" id="fileDelBtn"><span class="btn_intd_deletefile_left">파일삭제</span></a></td>
                              </tr>
                              <tr>
                ...
                <table class="form_summit_area">
                    <tr><td>                
                        ...
                        <a href="javascript:void(0)" class="btn_gray" onclick="getPageAction(3)" id="saveBtn"><span class="btn_gray_left">저장</span></a>                                         
                        <a href="javascript:void(0)" class="btn_gray" onclick="getPageAction(4)" id="delBtn"><span class="btn_gray_left">삭제</span></a>
                    </td></tr>
                </table>
            </form>               
<!-- 컨텐츠 영역 끝 -->              
