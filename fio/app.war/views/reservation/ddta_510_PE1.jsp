		...
		switch(action){
			...
			case 3:
				...
				if(validationCheck()){
					...
					mailContent += "</TABLE>";
					mailContent += "<BR/>";
					mailContent += "위 내용의 출입예약을 승인 요청합니다.<br/>";
					
					// mailContent += "<a href='http://10.10.21.145:8180/fio/DDTA.RSVTN.P01.cmd?param="+JSON.stringify({vsitRsvtnNo:$.trim(frm.new_VsitRsvtnNo.value), acceptCode:"§acceptCode§"})+"' target='_blank' style='font-size:12px;font-weight:bold;color:red'>승인하러 가기</a>";
	...
	<div class="popup_content mt10">
		...
		<form id="frm" name="frm">
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width:100%">
				<tr>
					<td align="left"><div class="popup_subtitle mb10">출입예약</div></td>
					<td align="right" style='padding-bottom:5px'><a class="btn_check" href="javascript:getPageAction(3)"><span class="btn_check_left">저장</span></a></td>
				</tr>
			</table>
...
<td class="cellstyle_textbox"><input type="text" id="intvUserTel" name="intvUserTel" maxlength="100" class="textbox_intd _tel" title="면담자를 조회해 주세요"/></td>
					...
					<tr>
						...
						<td class="cellstyle_textbox">
							<input type="text" id="vsitRsvtnFromDate" name="vsitRsvtnFromDate" size="13" maxlength="10" class="calendar_intd"/>
					...
					<tr>
						...
						<td colspan="3" class="tbl_colored_title" style="text-align:left !important">
							...
							<span id="visiotrBtnArea" style="text-align:left;display:none">
								...
								<a href="javascript:removeVisitor()" class="btn_intd"><span class="btn_intd_left">삭제</span></a>
